...
This can be described using a variety of non-linear functions, see
[`SchoolfieldIntrinsicGrowth`](@ref) for an implementation. 
"""
...
"""
struct SchoolfieldIntrinsicGrowth{K,P,HA,HL,HH,TL,TH,TR,R} <: GrowthModel{K}
    p::P
    ΔH_A::HA
    ΔH_L::HL
    ΔH_H::HH
